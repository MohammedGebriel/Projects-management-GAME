...
export default function MileStonesTask() {
    return (
        <div className="py-[10px] flex flex-col gap-[10px] rounded-[10px] border border-[#DBEDF5] shadow px-[10px] lg:px-[20px]">
            <div className="header flex justify-between">
                <div className="flex gap-[5px] text-[#09242E] items-center">
                    <FaFileAlt className="text-[16px]"/>
                    <p className="font-medium text-[10px] lg:text-[16px] text-[#041116]">Task Title</p>
                </div>
            ...
            <div className="flex flex-col sm:flex-row gap-[10px] justify-between items-center">
                <div className="flex items-center gap-[10px]">
                    ...
                    <span className="font-medium text-[14px] text-[#041116]">Completion Rate</span>
                </div>
                <div className="flex items-center gap-[10px] min-w-[160px] ">
                    ...
                    {/* <p className="text-[12px] font-bold text-[#041116]">Units</p> */}
                    <p className="text-[12px]  text-[#30637C]">%</p>
                </div>
            </div>
            <div className="flex flex-col sm:flex-row gap-[10px] justify-between items-center">
                <div className="flex items-center gap-[10px]">
