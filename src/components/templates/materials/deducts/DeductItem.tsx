        ...
        <div className="card">
            <div className="flex justify-between">
                <div className="flex gap-1.5 text-brandColor items-center">
                    <FaCircleMinus className="text-base"/>
                    <p className="font-medium text-10 lg:text-base text-darkColor">Deduct</p>
                </div>
            ...
            <div className="flex items-center justify-between">
                <p className="text-sm font-medium text-darkColor">Deduct Title</p>
