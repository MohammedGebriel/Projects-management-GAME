        ...
        <div className="py-[10px] flex flex-col gap-[15px] rounded-[10px] border border-[#DBEDF5] shadow px-[10px] lg:px-[20px]">
            <div className="header flex justify-between">
                <div className="flex gap-[5px] text-[#09242E] items-center">
                    <FaRightLeft className="text-[16px]"/>
                    <p className="font-medium text-[10px] lg:text-[16px] text-[#041116]">Return</p>
                </div>
            ...
            <div className="flex items-center justify-between">
                <p className="text-[14px] font-medium text-[#041116]">Return Title</p>
