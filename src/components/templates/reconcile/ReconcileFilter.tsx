...
export default function ReconcileFilter() {
    return (
        <div className="lg:px-2.5 flex lg:gap-20  justify-between">
            <div className="hidden lg:flex gap-4">
                ...
                <button className="size-7  flex justify-center items-center rounded bg-white border border-mainBorder shadow"><FaThLarge/></button>
            </div>
